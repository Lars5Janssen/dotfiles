...
_G.packer_plugins = {
  LuaSnip = {
    loaded = true,
    path = "/home/lars/.local/share/nvim/site/pack/packer/start/LuaSnip",
  ...
  ["cmp-nerdfont"] = {
    loaded = true,
    path = "/home/lars/.local/share/nvim/site/pack/packer/start/cmp-nerdfont",
  ...
  ["cmp-nvim-lua"] = {
    loaded = true,
    path = "/home/lars/.local/share/nvim/site/pack/packer/start/cmp-nvim-lua",
  ...
  cmp_luasnip = {
    loaded = true,
    path = "/home/lars/.local/share/nvim/site/pack/packer/start/cmp_luasnip",
  ...
  ["dashboard-nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/lars/.local/share/nvim/site/pack/packer/opt/dashboard-nvim",
  ...
  harpoon = {
    loaded = true,
    path = "/home/lars/.local/share/nvim/site/pack/packer/start/harpoon",
  ...
  ["mason-lspconfig.nvim"] = {
    loaded = true,
    path = "/home/lars/.local/share/nvim/site/pack/packer/start/mason-lspconfig.nvim",
    url = "https://github.com/williamboman/mason-lspconfig.nvim"
  },
  ["mason.nvim"] = {
    loaded = true,
    path = "/home/lars/.local/share/nvim/site/pack/packer/start/mason.nvim",
  ...
  ["nvim-colorizer.lua"] = {
    loaded = true,
    path = "/home/lars/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua",
    url = "https://github.com/norcalli/nvim-colorizer.lua"
  },
  ["nvim-lint"] = {
    loaded = true,
    path = "/home/lars/.local/share/nvim/site/pack/packer/start/nvim-lint",
  ...
  ["nvim-tree.lua"] = {
    loaded = true,
    path = "/home/lars/.local/share/nvim/site/pack/packer/start/nvim-tree.lua",
  ...
  playground = {
    loaded = true,
    path = "/home/lars/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["telescope.nvim"] = {
    loaded = true,
    path = "/home/lars/.local/share/nvim/site/pack/packer/start/telescope.nvim",
    url = "https://github.com/nvim-telescope/telescope.nvim"
  },
  undotree = {
    loaded = true,
    path = "/home/lars/.local/share/nvim/site/pack/packer/start/undotree",
  ...
  ["vim-illuminate"] = {
    loaded = true,
    path = "/home/lars/.local/share/nvim/site/pack/packer/start/vim-illuminate",
    url = "https://github.com/RRethy/vim-illuminate"
  },
  ["which-key.nvim"] = {
    config = { "\27LJ\2\nt\0\0\3\0\a\0\0156\0\0\0009\0\1\0+\1\2\0=\1\2\0006\0\0\0009\0\1\0)\1,\1=\1\3\0006\0\4\0'\2\5\0B\0\2\0029\0\6\0004\2\0\0B\0\2\1K\0\1\0\nsetup\14which-key\frequire\15timeoutlen\ftimeout\6o\bvim\0" },
    loaded = true,
    path = "/home/lars/.local/share/nvim/site/pack/packer/start/which-key.nvim",
